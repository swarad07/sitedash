 ...
 * @ContentEntityType(
 *   id = "sitedash_entity",
 *   label = @Translation("Sitedash entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\sitedash\SitedashListBuilder",
 ...
 *     },
 *     "access" = "Drupal\sitedash\SitedashAccessControlHandler",
 *   },
 *   base_table = "sitedash",
 *   admin_permission = "administer sitedash entity",
 *   fieldable = TRUE,
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 ...
 *   },
 *   links = {
 *     "canonical" = "/sitedash_entity/{sitedash_entity}",
 *     "edit-form" = "/sitedash_entity/{sitedash_entity}/edit",
 *     "delete-form" = "/sitedash/{sitedash_entity}/delete",
 *     "collection" = "/sitedash_entity/list"
 *   },
 *   field_ui_base_route = "sitedash.sitedash_settings",
 * )
 *
 ...
 * Example: 'entity.sitedash_entity.canonical'
 *
 * See routing file above for the corresponding implementation
 *
 * The 'Sitedash' class defines methods and fields for the sitedash entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see SitedashInterface) also exposes the EntityOwnerInterface.
...
class Sitedash extends ContentEntityBase implements SitedashInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Sitedash entity.'))
      ->setReadOnly(TRUE);

    // Standard field, unique outside of the scope of the current project.
    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the Sitedash entity.'))
      ->setReadOnly(TRUE);

    // Site Name field for the sitedash.
